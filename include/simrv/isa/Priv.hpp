...
/**
 * @enum Funct12Priv
 * @brief Represents the 12-bit privileged system instruction selectors (bits [31:20] of SYSTEM instructions).
 */
...
/**
 * @enum Funct7Priv
 * @brief Represents the 7-bit privileged virtual memory instruction selectors (bits [31:25] of SYSTEM instructions).
 */
enum class Funct7Priv : uint8_t {
    SfenceVma = 0x09, ///< Supervisor Memory-Management Fence (SFENCE.VMA, invalidates page table TLB entries)
};
