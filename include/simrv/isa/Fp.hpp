...
enum class Funct7Fp : Word {
    ...
    FcvtWS = 0x60,   ///< Convert Single to Integer Word/Doubleword (FCVT.W.S, FCVT.WU.S, FCVT.L.S, FCVT.LU.S)
    FcvtWD = 0x61,   ///< Convert Double to Integer Word/Doubleword (FCVT.W.D, FCVT.WU.D, FCVT.L.D, FCVT.LU.D)
    FcvtSW = 0x68,   ///< Convert Integer Word/Doubleword to Single (FCVT.S.W, FCVT.S.WU, FCVT.S.L, FCVT.S.LU)
    FcvtDW = 0x69,   ///< Convert Integer Word/Doubleword to Double (FCVT.D.W, FCVT.D.WU, FCVT.D.L, FCVT.D.LU)
