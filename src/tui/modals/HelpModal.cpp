...
void HelpModal::render(std::vector<std::string>& content_rows,
    ...
    if (term_height < 32 && box_w >= 70) {
        ...
        add_row_cb(std::format(" {}{:<22}\033[0m {}Single instruction step\033[0m", kThemeSky,
                            "[s] / [Space]", kThemeText));
        add_row_cb(std::format(" {}{:<22}\033[0m {}Step N instructions\033[0m", kThemeSky,
                            "[n]", kThemeText));
        add_row_cb(std::format(" {}{:<22}\033[0m {}Undo / Step back 1 instruction\033[0m",
        ...
        add_row_cb(std::format(" {}{:<22}\033[0m {}Set Memory Watchpoint modal\033[0m", kThemeSky,
                            "[w]", kThemeText));
        add_row_cb(std::format(" {}{:<22}\033[0m {}Toggle PC breakpoint at current PC\033[0m",
                            kThemeSky, "[k]", kThemeText));
        add_row_cb(std::format(" {}{:<22}\033[0m {}Set Step Size (N) modal\033[0m", kThemeSky,
                            "[g]", kThemeText));
        add_row_cb(std::format(" {}{:<22}\033[0m {}Set Speed Frequency (Hz) modal\033[0m",
                            kThemeSky, "[f]", kThemeText));
        add_row_cb(std::format(" {}{:<22}\033[0m {}Inspect Memory Address modal\033[0m",
                            kThemeSky, "[m]", kThemeText));
        add_row_cb(std::format(" {}{:<22}\033[0m {}Run / Pause simulation loop\033[0m",
                            kThemeSky, "[c] / [Ctrl-P]", kThemeText));
        add_row_cb(std::format(" {}{:<22}\033[0m {}Cycle TUI panel layout\033[0m", kThemeSky,
                            "[Tab]", kThemeText));
        add_row_cb(
        ...
        add_row_cb(std::format(" {}{:<22}\033[0m {}Cycle Right Pane mode\033[0m", kThemeSky,
                            "[p] / [Alt-p]", kThemeText));
        add_row_cb(std::format(" {}{:<22}\033[0m {}Jump to Explainer / Trap Details\033[0m",
                            kThemeSky, "[e] / [Alt-e]", kThemeText));
        add_row_cb(std::format(" {}{:<22}\033[0m {}Toggle trace recording\033[0m", kThemeSky,
                            "[v] / [Alt-v]", kThemeText));
        add_row_cb(std::format(" {}{:<22}\033[0m {}Scroll trace / log views\033[0m", kThemeSky,
                            "[u/d] / [Up/Dn/PgUp/Dn]", kThemeText));
        add_row_cb(std::format(" {}{:<22}\033[0m {}Scroll registers view\033[0m", kThemeSky,
                            "[Alt-w/s]", kThemeText));
        add_row_cb(std::format(" {}{:<22}\033[0m {}Adjust left pane width\033[0m", kThemeSky,
                            "[ [ / ] ]", kThemeText));
        add_row_cb(std::format(" {}{:<22}\033[0m {}Show this help dialog\033[0m", kThemeSky,
                            "[F1] / [h] / [?]", kThemeText));
        add_row_cb(std::format(" {}{:<22}\033[0m {}Toggle High Contrast theme\033[0m",
                            kThemeSky, "[Alt-h]", kThemeText));
        add_row_cb(std::format(" {}{:<22}\033[0m {}Toggle Sakura Pastel theme\033[0m",
                            kThemeSky, "[Alt-t]", kThemeText));
        add_row_cb(std::format(" {}{:<22}\033[0m {}Close modal dialog\033[0m", kThemeSky,
                            "[Esc]", kThemeText));
    }
}
