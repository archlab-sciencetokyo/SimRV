...
SIMRV_CMAKE_PRESET_RV32="${SIMRV_CMAKE_PRESET_RV32:-ninja-clang-release}"
SIMRV_CMAKE_PRESET_RV64="${SIMRV_CMAKE_PRESET_RV64:-ninja-clang-release-rv64}"
...
SIMRV_BIN_RV32="${SIMRV_BIN_RV32:-$ROOT_DIR/build/ninja-clang-release/SimRV}"
SIMRV_BIN_RV64="${SIMRV_BIN_RV64:-$ROOT_DIR/build/ninja-clang-release-rv64/SimRV}"
